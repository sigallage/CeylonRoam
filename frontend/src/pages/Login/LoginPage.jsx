...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f5f5f5] px-4 py-12">
      <div className="bg-white px-16 py-12 rounded-[16px] border border-[#e5e7eb] shadow-[0_20px_40px_rgba(15,23,42,0.08)] w-full max-w-[460px]" style={{ backgroundColor: '#ffffff' }}>
        <div className="max-w-[360px] mx-auto"><br></br>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-6">
            <div>
              <label htmlFor="email" className="block mb-3 text-[#333] font-normal text-[17px]">
                Email
              </label>
              <input
                type="email"
          ...
          <button 
            ...
            className="w-full py-3.5 bg-white border border-[#ddd] rounded-[6px] flex items-center justify-center hover:bg-[#f5f5f5] transition-colors"
          >
            <svg width="20" height="40" viewBox="0 0 24 24" className="flex-shrink-0">
